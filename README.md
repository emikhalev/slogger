...
Package to send messages to syslog. It has an internal buffer to store messages and RELP protocol support.<br/>
...
Usage example:
	...
	l, err := logger.New(ctx, syslog.SyslogProtocolRELP, testSyslogAddrRELP, testSyslogTag, 
	                        32, 10*time.Millisecond, 128)
